 ...
 * Entrada:	endereco: endereço da memoria de dados do display que se colocar o cursor
 * Saída:	Nenhuma (void)
 ...
 * Entrada:     valor: numero inteiro com sinal (de -32768 a 32767) a ser escrito no display.
 * Saída:         Nenhuma (void)
 ...
 * Entrada:     valor:   numero float com sinal (de -9999.9999 a 9999.9999) que será escrito no display
