...
#define INDEX_TAREFA_6                 5
#define INDEX_TAREFA_7                 6
#define INDEX_TAREFA_8                 7
#define NUMBER_OF_TASKS                8
#define TIME_TO_EXECUTE_TASK1          10  //time unit: ms
#define TIME_TO_EXECUTE_TASK2          1000  //time unit: ms
#define TIME_TO_EXECUTE_TASK3          1000  //time unit: ms
#define TIME_TO_EXECUTE_TASK4          1  //time unit: ms
#define TIME_TO_EXECUTE_TASK5          100  //time unit: ms
#define TIME_TO_EXECUTE_TASK6          1  //time unit: ms
#define TIME_TO_EXECUTE_TASK7          1  //time unit: ms
#define TIME_TO_EXECUTE_TASK8          100  //time unit: ms
#define TASK_TIMEOUT                   100  //time unit: ms
